...
#ifdef TD100_F031
#define FILE_NAME "TD100_F031"
#define FIRMWARE_NAME "TD-TRUE F031"
#define DEAD_TIME 45
#define HARDWARE_GROUP_F031_C
#define TARGET_STALL_PROTECTION_INTERVAL 8000
#define TARGET_VOLTAGE_DIVIDER 152
#define MILLIVOLT_PER_AMP 16.5
#define USE_SERIAL_TELEMETRY 
...
#define PHASE_A_EXTI_PIN LL_GPIO_PIN_0  //SENSE_V (LSV, HSV)
#define PHASE_B_EXTI_PIN LL_GPIO_PIN_1  //SENSE_U (LSU, HSU)
#define PHASE_C_EXTI_PIN LL_GPIO_PIN_6  //SENSE_W (LSW, HSW)
...
#define PHASE_A_GPIO_LOW LL_GPIO_PIN_14     //(LSV, LS2)
#define PHASE_A_GPIO_PORT_LOW GPIOB
#define PHASE_A_GPIO_HIGH LL_GPIO_PIN_9     //(HSV, HS2)
#define PHASE_A_GPIO_PORT_HIGH GPIOA

#define PHASE_B_GPIO_LOW LL_GPIO_PIN_13     //(LSU, LS1)
#define PHASE_B_GPIO_PORT_LOW GPIOB
#define PHASE_B_GPIO_HIGH LL_GPIO_PIN_8     //(HSU, HS1)
#define PHASE_B_GPIO_PORT_HIGH GPIOA

#define PHASE_C_GPIO_LOW LL_GPIO_PIN_15     //(LSW, LS3)
#define PHASE_C_GPIO_PORT_LOW GPIOB
#define PHASE_C_GPIO_HIGH LL_GPIO_PIN_10    //(HSW, HS3)
#define PHASE_C_GPIO_PORT_HIGH GPIOA
